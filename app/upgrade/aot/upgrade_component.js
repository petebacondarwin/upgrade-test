...
export var UpgradeComponent = (function () {
    function UpgradeComponent(name, elementRef, injector) {
        ...
        if (this.directive.bindToController && controllerType) {
            this.bindingDestination =
                this.buildController(controllerType, this.$componentScope, this.$element, this.directive.controllerAs);
        }
        else {
    ...
    UpgradeComponent.prototype.ngOnInit = function () {
        ...
        if (!this.directive.bindToController && this.directive.controller) {
            this.buildController(this.directive.controller, this.$componentScope, this.$element, this.directive.controllerAs);
        }
    ...
    UpgradeComponent.prototype.ngOnChanges = function (changes) {
        ...
        Object.keys(changes).forEach(function (propName) {
            _this.bindingDestination[propName] = changes[propName].currentValue;
        });
